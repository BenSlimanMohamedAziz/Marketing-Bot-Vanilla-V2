...
class Settings:
    def __init__(self):
        ...
        self.LLAMA_API_URL = get_env("LLAMA_API_URL", "url")
        ...
        self.GROQ_API_URL = get_env("GROQ_API_URL", "url")
        ...
        self.TAVILY_API_URL = get_env("TAVILY_API_URL", "url")
        ...
        self.FIRECRAWL_API_URL = get_env("FIRECRAWL_API_URL", "urle")
